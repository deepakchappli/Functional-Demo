...
public class Credit_card_self_heal extends SelfHealingBaseTest{

	@Test(description = "First Test", dataProvider = "getTestDataFromExcel", enabled = false)
	public void test(String userName, String password) throws FilloException {
		
		Eyes eyes = EyesInstance.instance().getEyesInstance();
		
		webdriverUtil.getUrl("https://demo.applitools.com/");
		...
		eyes.check(Target.window().fully().withName("Home Screen"));
